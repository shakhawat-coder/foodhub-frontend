...
export function AddBannerForm() {
    ...
    async function onSubmit(values: any) {
        ...
        try {
            const submitData = {
                ...values,
                images: [values.image] // Wrap single image in array as expected by backend
            }
            ...
            toast.error(error.message || "An error occurred while creating the banner")
        } finally {
            setIsLoading(false)
        }
    }
    ...
    return (
        <Card className="max-w-4xl mx-auto">
            <CardHeader>
                ...
                <CardDescription>
                    Fill in the details for the homepage hero carousel.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
