        ...
        <div className='py-20'>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-5">
                {topRestaurants.map((restaurant) => (
                    <div key={restaurant.id} className="flex flex-col items-center justify-center">
                        ...
                        <Link href={`/restaurants/${restaurant.id}`} className="mt-4 text-lg font-semibold text-center">{restaurant.name}</Link>
